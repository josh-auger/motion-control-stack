...
Docker container to monitor a local directory queue and process image files as they are delivered into that directory.\
...
the final alignment transform files to a local file directory.
