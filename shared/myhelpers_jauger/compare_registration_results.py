...
{figure_group([('runtime_comparison.png','Figure 9. Optimizer and end-to-end registration-call runtime distributions.'),('cost_evaluations_comparison.png','Figure 10. Optimizer cost-evaluation counts. CUDA SimpleITK only exposes the number of "Powell cycles", not total number of metric evaluations.')])}
